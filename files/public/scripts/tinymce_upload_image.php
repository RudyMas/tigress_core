...
$destinationPath = '../../public/images/tinymce/' . $_GET['folder'] . '/' . $randomText . '_' . $_FILES['file']['name'];

// check if the folder exists, if not, create it
if (!file_exists('../../public/images/tinymce/' . $_GET['folder'])) {
    mkdir('../../public/images/tinymce/' . $_GET['folder'], 0777, true);
}
